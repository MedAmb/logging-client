...
int main() {
  const auto &config_parser = logger::config_parser::YamlConfigParser::create(
      "/home/mohamed/workspace/logging/config.yaml");
  ...
  std::cout << "Default log context id: "
            << config_parser.getDefaultLogContextId() << std::endl;
